...
|2|🇧🇾 FTL|[Advanced Drona 2](advanced_drona_simulator.md)|19.9|
|3|🇷🇺 Drona Rescue Team|[Rescue Drona](../en/drona-rescue-team.html)|17.7|
...
2. Облачная платформа для [симулятора Клевера](https://drona.coex.tech/ru/simulation.html) по аналогии или на основе [ROS Development Studio](https://app.theconstructsim.com/).
...
Подготовьте вашу заявку и пришлите ее в виде Draft Pull Request в [репозиторий Клевера](https://github.com/CopterExpress/drona).
