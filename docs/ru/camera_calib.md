...
Нажимаем “Войти”. Переходим в ***/home/pi/catkin_ws/src/drona/drona/camera_info/*** и копируем туда калибровочный .yaml файл:
...
Войдем под логином ***pi*** и паролем ***raspberry***, перейдем в директорию ***/home/pi/catkin_ws/src/drona/drona/launch*** и начнем редактировать конфигурацию ***main_camera.launch***:
