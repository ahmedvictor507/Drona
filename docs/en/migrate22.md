...
Python 2 is [deprecated](https://www.python.org/doc/sunset-python-2/) since January 1st, 2020. The Drona platform moves to Python 3.
...
```python
print 'Drona is the best'  # this won't work
```

use `print` *function*:

```python
print('Drona is the best')
```
