...
Для Raspberry Pi версий до 3B+: [v0.18](https://github.com/CopterExpress/drona/releases/tag/v0.18)

Для Raspberry Pi версии 4: [v0.19-alpha.1](https://github.com/CopterExpress/drona/releases/tag/v0.19-alpha.1)
