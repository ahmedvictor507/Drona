...
4. Для Клевера 4 выберите подтипа рамы *COEX Drona 4*. В ином случае – *Generic Quadrotor X*.
...
> **Info** Использование типа рамы *COEX Drona 4* не требует ввода коэффициентов PID.
