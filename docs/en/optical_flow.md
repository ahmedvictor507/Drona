...
Enable Optical Flow in the file `~/catkin_ws/src/drona/drona/launch/drona.launch`:
...
> **Hint** Suggested parameters are applied automatically in [our custom PX4 firmware](firmware.md#modified-firmware-for-drona).
