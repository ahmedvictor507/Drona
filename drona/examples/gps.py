# Information: https://drona.coex.tech/en/simple_offboard.html#navigateglobal
...
# https://drona.coex.tech/en/snippets.html#wait_arrival
...
if math.isnan(start.lat):
    raise Exception('No global position, install and configure GPS sensor: https://drona.coex.tech/gps')
