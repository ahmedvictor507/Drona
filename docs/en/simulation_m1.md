...
2. Download Ubuntu Linux 20.04 installation iso-file for ARM64 architecture using the link: https://dronavm.ams3.digitaloceanspaces.com/focal-desktop-arm64.iso.
