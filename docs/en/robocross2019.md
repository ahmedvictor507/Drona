...
The team used an F450 frame based quadcopter and [Drona software platform](https://github.com/CopterExpress/drona). The final source code is available [on GitHub](https://github.com/CopterExpress/robocross2019/).
