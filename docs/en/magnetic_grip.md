...
To monitor the status of the electromagnetic gripper, you can connect the *ws281x* LED strip (included to Drona kit). Connect it to power +5v – 5v, ground GND – GND, and signal wire DIN – Arduino D12.
