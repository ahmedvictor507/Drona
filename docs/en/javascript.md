...
All the required software is preinstalled in [RPi image](image.md) for Drona.
...
<html>
	...
	<script type="text/javascript">
		...
		var getTelemetry = new ROSLIB.Service({ ros: ros, name : '/get_telemetry', serviceType : 'drona/GetTelemetry' });
...
The page should be placed in the `/home/pi/catkin_ws/src/drona/drona/www/` directory. After that, it will be available at `http://192.168.11.1/drona/<page_name>.html`. When the page is opened, browser should show an alert with the drone telemetry and constantly print the state of the flight controller to the console.
...
See an example of simplified web ground control station on Drona at http://192.168.11.1/drona/gcs.html.
