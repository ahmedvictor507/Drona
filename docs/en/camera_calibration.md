...
3. Connect to the [Drona Wi-Fi network](wifi.md).
...
7. Click the *COMMIT* button to store calculated calibration parameters. The result will be stored in the main Drona camera calibration file: `/home/pi/catkin_ws/src/drona/drona/camera_info/fisheye_cam_320.yaml`.
