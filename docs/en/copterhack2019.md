...
Raspberry Pi versions 3B+ and lower: [v0.18](https://github.com/CopterExpress/drona/releases/tag/v0.18)

Raspberry Pi version 4: [v0.19-alpha.1](https://github.com/CopterExpress/drona/releases/tag/v0.19-alpha.1)
